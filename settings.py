...
# Debug
PRINT_UART_DEBUG = False
PRINT_FRAME_DEBUG = False
...
RADAR_TILT_ANGLE_DEG = 0.0    # Góc nghiêng chĩa xuống của radar (độ) - Đã sửa theo ảnh thực tế nhìn thẳng
RADAR_MOUNT_HEIGHT_M = 1.04   # Chiều cao lắp đặt radar so với mặt đất (mét) - đã điều chỉnh theo thực tế của người dùng
...
HUMAN_CLUSTER_MIN_HEIGHT_Z = 0.15           # Hạ xuống 15cm để không loại bỏ người nằm bẹt
HUMAN_CLUSTER_MAX_HEIGHT_Z = 2.20
HUMAN_CLUSTER_MIN_WIDTH_X = 0.05
HUMAN_CLUSTER_MAX_WIDTH_X = 2.00            # Tăng lên 2.0m để nhận diện người nằm ngang dọc trục X
HUMAN_CLUSTER_MAX_DEPTH_Y = 2.00            # Tăng lên 2.0m để nhận diện người nằm dọc trục Y
...
HUMAN_SCORE_TARGET_THRESHOLD = 38.0
...
VIRTUAL_CLUSTER_SCORE_THRESHOLD = 55.0       # Giảm xuống 55.0 để lock virtual target đối với người nằm tĩnh
...
# ============================================================
# HTTP API SETTINGS (Version 27.0)
# ============================================================
ENABLE_HTTP_API = True
HTTP_API_HOST = "0.0.0.0"
HTTP_API_PORT = 5002             # Cổng 5002 theo yêu cầu


# ============================================================
# DEEP LEARNING FALL DETECTION CONFIGURATION (Version 28.0)
# ============================================================
ENABLE_DEEP_FALL_DETECTION = False         # Mặc định tắt, chỉ bật khi đã deploy model lên IQ9
DEEP_FALL_MODEL_PATH = "models/radar_fall_detection_quantized.dlc" # Đường dẫn model (hoặc *.onnx)
DEEP_FALL_SEQ_LEN = 30                    # Độ dài chuỗi quan sát (30 frame = 1.5s tại 20 FPS)
DEEP_FALL_NUM_POINTS = 32                 # Số lượng điểm cố định sau khi Resampling
